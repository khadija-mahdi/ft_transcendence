const routes = {
	...
	"/tournaments/tournament": { title: "Tournament", component: () => import("/components/tournament/View/Tournament.js"), css: '/components/tournament/assets/Tournament.css', controller: () => import('/components/tournament/Controller/Tournament.js') },
	...
	"*": { title: "404 Not Found", component: () => import('./lib/NotFound/NotFound.js'), css: './lib/NotFound/notFound.css' },
