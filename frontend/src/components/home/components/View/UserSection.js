		...
		<div id="team-leader">
			<a href="/profile" class="profile-link">
				...
				<div class="profile-info">
					<div id="fullname" class="profile-name"></div>
					<div class="profile-status">Your Status</div>
				</div>
			</a>

			<div class="progress">
				<div id="rank-name" class="progress-rank"></div>
				<div id="current-xp" class="progress-xp"></div>
			</div>

			<div id="chart-container" class="chart-container">
				<div id="chart-message" class="empty-message">You don't have progress data yet!</div>
			</div>
			...
			<div class="stats">
				<div class="stat-item">
					...
					<div id="rank-order" class="stat-value"></div>
				</div>
				...
				<div class="stat-item">
					...
					<div id="coins" class="stat-value"></div>
				</div>
			</div>
			...
			<a href="/messenger" class="message-link">
				<div class="message-item">
					<div class="message-label">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M18.5481 18.5225C16.693 20.3778 14.2512 21.2761 11.8247 21.2237C8.5295 21.1525 2.75 21.2042 2.75 21.2042C2.75 21.2042 2.80068 15.357 2.79819 12.0045C2.79644 9.64195 3.69595 7.27993 5.50162 5.47466C9.10096 1.874 14.9487 1.874 18.5481 5.47373C22.1539 9.07996 22.1474 14.9228 18.5481 18.5225Z" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
							<path d="M8.31468 12.3808H8.21593" stroke="white" stroke-width="1.5" stroke-linecap="square"/>
							<path d="M12.0489 12.3809H11.9502" stroke="white" stroke-width="1.5" stroke-linecap="square"/>
							<path d="M15.7832 12.3808H15.6845" stroke="white" stroke-width="1.5" stroke-linecap="square"/>
						</svg>
						Messages
					</div>
