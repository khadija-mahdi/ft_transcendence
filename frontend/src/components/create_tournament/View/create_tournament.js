	...
	<div class="create-tr-container">
		...
		<form class="create-form-container" id="createTournamentForm">
			...
			<div class="form-group">
				...
				<input type="text" id="name" class="form-input" placeholder="New Tournament Name" required />
			</div>
			...
			<div class="form-group">
				...
				<textarea id="description" class="form-input-des" placeholder="Please provide any relevant details you would like to share with players." required></textarea>
			</div>
			...
			<div class="toggle-group">
				...
				<div class="toggle-item">
					<div class="toggle-text">
						<span class="text-muted">Make your tournament public so that everyone can join.</span>
					</div>
					<label class="switch">
				...
				<strong style="color: #FFFFFF !important;">Monetize</strong>
				<div class="toggle-item">
					<div class="toggle-text">
						<span class="text-muted">By enabling this feature, your tournament will be featured on the homepage.</span>
					</div>
					<label class="switch">
