  ...
  function init() {
    ...
    loader_scene1.load(
      ...
      (glb) => {
        ...
        table_position = {
          x: tableModel.position.x,
          y: tableModel.position.y,
          z: tableModel.position.z,
        };
        ...
        console.log("tableWidth => ", tableWidth, "tableHeight => ", size.y);
    ...
    loader.load(
      ...
      (glb) => {
        ...
        ballModel.position.set(table_position.x+20, -720, -1000);
    ...
    function handleWebSocketMessages(message) {
      ...
      if (data.type === "update" && data.ball) latestBallData = data.ball;
    ...
    window.addEventListener("keydown", (event) => {
      ...
      switch (event.key) {
        case "ArrowLeft":
          if (player_model.position.x > -tableWidth / 2) {
            // Check left boundary
            moveLeftPlayer = true;
        ...
        case "a": // 'a' key for moving the computer paddle left
          if (computer.position.x > -tableWidth / 2) {
            // Check left boundary
